IF OBJECT_ID ('dbo.sp_reporte_cuadro_sib') IS NOT NULL
	DROP PROCEDURE dbo.sp_reporte_cuadro_sib
GO
...
begin
   ...
   begin         
      ...
      and   j.ju_estado not in (@w_estado_archivado, @w_estado_no_vigente, @w_estado_anualdo)      
      ...
      begin           
		...
		/* Adaptive Server has expanded all '*' elements in the following statement */ INSERT  cv_reporte_inventario_sib
		SELECT #cv_reporte_inventario_sib.is_fecha_proceso, #cv_reporte_inventario_sib.is_secuencial, #cv_reporte_inventario_sib.is_secuencia_ju, #cv_reporte_inventario_sib.is_num_juicio, #cv_reporte_inventario_sib.is_anio, #cv_reporte_inventario_sib.is_coactivado, #cv_reporte_inventario_sib.is_garante, #cv_reporte_inventario_sib.is_fec_auto_pago, #cv_reporte_inventario_sib.is_cuantia_inicial, #cv_reporte_inventario_sib.is_riesgo_actual, #cv_reporte_inventario_sib.is_etapa_procesa, #cv_reporte_inventario_sib.is_fec_ult_providencia, #cv_reporte_inventario_sib.is_observacion, #cv_reporte_inventario_sib.is_abogado, #cv_reporte_inventario_sib.is_oficina_procesa, #cv_reporte_inventario_sib.is_doficina_procesa FROM #cv_reporte_inventario_sib
