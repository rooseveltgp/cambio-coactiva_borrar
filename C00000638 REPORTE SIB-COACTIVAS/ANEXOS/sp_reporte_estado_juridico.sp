...
go
/*************************************************************************/
/*   Archivo:            sp_reporte_estado_juridico.sp                   */
/*   Stored procedure:   sp_reporte_estado_juridico                      */
/*   Base de datos:      cob_coactiva                                    */
/*   Producto:           Coactiva                                        */
/*   Disenado por:       Adriana Giler                                   */
/*   Fecha de escritura: 02-octubre-2012                                 */
/*************************************************************************/
/*                               IMPORTANTE                              */
...
/*                              MODIFICACIONES                           */
/*   FECHA            AUTOR                      RAZON                   */
/*   19-Abr-2012      Jacqueline Bulla     Version Inicial               */
/*   30-Dic-2023      JAnaguano            C00000368	                 */
/*************************************************************************/

use cob_coactiva
go
if not object_id('sp_reporte_estado_juridico') is null
   drop proc sp_reporte_estado_juridico
go
...
select  @w_estado_preliminar = 'P'	--CAMBIO     
...
begin
   ...
   begin
	  ...
	  and  (substring(j.ju_juicio,1,2) <> "FP" ) --C00000368
...
fin:
   return 0
go
grant exec on cob_coactiva..sp_reporte_estado_juridico to reports
go
set replication on
go
